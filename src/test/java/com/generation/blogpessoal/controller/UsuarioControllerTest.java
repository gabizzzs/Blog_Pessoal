...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario (0L, "Paulo Antunes", "paulo_antunes@email.com", "13465278", "https://i.imgur.com/JR7KUFU.jpg"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(),
				"Juliana Andrews Ramos", "juliana_andrews@email.com.br", "juliana123", "https://i.imgur.com/yDRVeK7.jpg");
